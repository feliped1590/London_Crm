...
-- Drop the version WITHOUT p_allowed_sales_rep_ids to avoid ambiguity
...
-- Recreate the version WITH p_allowed_sales_rep_ids that actually uses the parameter
...
RETURNS TABLE (
  ...
  last_interaction_at text, last_order_at text,
  total_count bigint,
  regiao text,
