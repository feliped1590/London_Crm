REVOKE ALL ON FUNCTION public.get_pipeline_health(UUID, DATE, DATE) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_seller_performance(DATE, DATE, BOOLEAN) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_bi_anomalies() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_stalled_deals_by_seller(UUID, INT) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_conversion_by_stage(DATE, DATE) FROM PUBLIC;
