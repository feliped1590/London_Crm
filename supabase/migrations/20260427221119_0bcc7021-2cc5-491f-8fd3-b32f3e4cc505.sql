...
BEGIN
  ...
  WITH anomalies AS (
    ...
    WHERE lower(unaccent(COALESCE(d.stage, ''))) NOT IN ('fechado_ganho', 'fechado ganho', 'ganho', 'fechado_perdido', 'fechado perdido', 'perdido')
...
COMMENT ON FUNCTION public.get_bi_anomalies IS 'BI Avançado: detecta anomalias comerciais com aliases explícitos e tolerância a estágios fechados textuais';