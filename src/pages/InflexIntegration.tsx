...
export default function InflexIntegration() {
  ...
  // Buscar contatos e empresas já importados (para verificar duplicatas)
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Integração Iniflex</h1>
          <p className="text-muted-foreground">Importe correntistas do ERP Iniflex para o CRM</p>
        </div>
