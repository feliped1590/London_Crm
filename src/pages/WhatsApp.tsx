...
import { MessageSquare, Smartphone, Settings } from 'lucide-react';
      ...
      <Tabs defaultValue="conversations" className="h-full flex flex-col">
        <div className="border-b px-6 py-3 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Gerencie conversas e instâncias Z-API</p>
          </div>
          <TabsList>
        ...
        <TabsContent value="instances" className="flex-1 m-0 overflow-auto p-6">
          <InstanceManager />
        </TabsContent>
      </Tabs>
    </div>
