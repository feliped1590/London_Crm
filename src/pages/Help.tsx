...
const helpSections: HelpSection[] = [
  ...
  {
    id: 'copiloto',
    title: '14. Copiloto IA',
    icon: Sparkles,
    description: 'Assistente inteligente com sugestões de ação contextualizadas.',
    content: [
      {
        subtitle: 'O que é o Copiloto',
        steps: [
          'O Copiloto é um assistente de IA que analisa seus dados.',
          'Ele sugere ações concretas baseadas no contexto atual.',
          'O Copiloto NUNCA executa ações sozinho — você decide.',
          'Todas as sugestões são explicadas com o "porquê".',
        ],
        tips: [
          'O Copiloto funciona melhor quando seus dados estão atualizados.',
        ],
      },
      {
        subtitle: 'Acessando o Copiloto',
        steps: [
          'Clique no ícone de "cérebro/lâmpada" no canto inferior da tela.',
          'O painel do Copiloto abre com as sugestões mais recentes.',
          'Clique em "Atualizar" para gerar novas sugestões.',
          'Sugestões são baseadas nos seus dados atuais.',
        ],
      },
      {
        subtitle: 'Tipos de Sugestões',
        steps: [
          'Follow-up: sugestões de contato com clientes inativos.',
          'Ação: tarefas específicas recomendadas.',
          'Revisão: negócios ou propostas que precisam de atenção.',
          'Alerta: situações críticas que requerem ação urgente.',
        ],
      },
      {
        subtitle: 'Aceitando uma Sugestão',
        steps: [
          'Leia a sugestão e o motivo explicado.',
          'Clique em "Aceitar" para executar a ação sugerida.',
          'O sistema prepara a ação (criar tarefa, abrir negócio, etc.).',
          'Você confirma antes de qualquer alteração ser feita.',
        ],
      },
      {
        subtitle: 'Descartando Sugestões',
        steps: [
          'Se a sugestão não for relevante, clique em "Descartar".',
          'Sugestões descartadas não aparecem novamente.',
          'O sistema aprende com suas escolhas para melhorar.',
          'Você pode ver sugestões descartadas no histórico.',
        ],
      },
      {
        subtitle: 'Contextos Analisados',
        steps: [
          'Dashboard: visão geral da sua performance.',
          'Pipeline: análise de negócios estagnados e oportunidades.',
          'Cliente específico: histórico e relacionamento.',
          'Vendedor: desempenho individual e comparativo.',
        ],
      },
    ],
  },
